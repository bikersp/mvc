...
// Actializar Cantidad y Total de Carrito
...
//Vaidar Terminos y condiciones
if (document.querySelector("#condiciones")) {
  let opt = document.querySelector("#condiciones");
  opt.addEventListener("click", function () {
    let opcion = this.checked;
    if (opcion) {
      document.querySelector("#opMetodoPago").classList.remove("notblock");
    } else {
      document.querySelector("#opMetodoPago").classList.add("notblock");
    }
  });
}
