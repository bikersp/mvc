          ...
          <?php if(isset($_SESSION['login'])){ ?>
            <div>
              ...
              <div class="bor8 bg0 m-b-12">
                <input id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="txtDireccion" placeholder="Dirección de envío">
              </div>
              <div class="bor8 bg0 m-b-22">
                <input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="txtCiudad" placeholder="Ciudad / Estado">
              </div>
            </div>
          <?php }else{ ?>
...
<?php if(isset($_SESSION['login'])){ ?>
          <div id="divMetodoPago" class="notblock">
            ...
            <div id="opMetodoPago" class="notblock">
              <hr>
              <h4 class="mtext-109 cl2 p-b-30">
                Método de pago
              </h4>
              <div class="divmetodpago">
                <div>
                  <label for="paypal">
                    ...
                    <img src="<?= media()?>/img/icon/paypal.jpg" alt="Icono de PayPal" class="ml-space-sm" width="74" height="20">
                  </label>
                </div>
                <div>
                ...
                <div id="divpaypal">
                  <div>
                    <p>
                      Para completar la transacción, te enviaremos a los servidores seguros de PayPal.
                    </p>
                  </div>
                  <br>
