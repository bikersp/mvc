...
<!-- Title page -->
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form id="frmContacto">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" src="<?= media() ?>/store/img/icons/icon-name.png" alt="ICON" style="width: 26px;">
						</div>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" src="<?= media() ?>/store/img/icons/icon-email.png" alt="ICON">
						</div>
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">
								<a class="" href="tel:<?= TELEFONO_EMPRESA ?>"><?= TELEFONO_EMPRESA ?></a>
							</p>
						</div>
					</div>
	...
	<div>
		<div class="container my-4 text-center">
			<h3 class="text-center my-3 text-center">Página en construcción</h3>
		</div>
	</div>
