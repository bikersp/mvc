		...
		<div class="container">
			...
			if(!empty($arrProductos)){
				for ($p=0; $p < count($arrProductos); $p++) {
					...
					if(count($arrProductos[$p]['images']) > 0 ){
						...
						$portada = media().'/img/uploads/product.png';
					}
			 ?>
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="<?= base_url().'/store/producto/'.$arrProductos[$p]['nombre']; ?>" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04" src="<?= media() ?>/store/img/icons/icon-heart-01.png" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l" src="<?= media() ?>/store/img/icons/icon-heart-02.png" alt="ICON">
								</a>
								<a href="#"
			...
			?>
				<div class="flex-c-m flex-w w-full p-t-45">
					...
					<a href="<?= base_url()?>/tienda/busqueda?p=<?= $prevPagina.'&s='.$data['busqueda']?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					...
					<a href="<?= base_url()?>/tienda/busqueda?p=<?= $nextPagina.'&s='.$data['busqueda']?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
						Siguiente &nbsp;
