...
?>
  ...
  <section class="bg0 p-t-23 p-b-140">
        ...
        <?php	
          for ($p=0; $p < count($arrProductos); $p++) { 
            ...
            if(count($arrProductos[$p]['images']) > 0 ){
              ...
              $portada = media().'/img/uploads/portada.png';
          }
        ?>
            ...
            <div class="block2-txt flex-w flex-t p-t-14">
              ...
              <div class="block2-txt-child2 flex-r p-t-3">
                ...
                <a href="#"
								 ...
								 icon-header-item cl2 hov-cl1 trans-04 p-l-15 p-r-0
								 ">
									<i class="zmdi zmdi-shopping-cart fs-19 d-block"></i>
								</a>
              </div>
            </div>
          </div>
    ...
    <!-- Content -->
    <div class="container page-content text-center p-t-80">
      <hr>
      <?= $contentPage ?>
    </div>
  </section>
