...
<head>
  ...
  <style>
    ...
    h4{font-family: arial;margin: 0;font-weight: bold;}
...
<body>
  <br>
  <p class="text-center">Se ha generado una orden, a continuación encontraraslos datos.</p>
  <br><hr><br>
  <table>
    <tr>
      <td width="33.33"><img class="logo" src="<?= media(); ?>/store/img/logo.png" alt="Logo" width="100"></td>
      <td width="33.33">
  ...
  <div class="text-center">
    <p>Si tienespreguntas sobre su pedido <br> pongase en contacto con nombre, teléfono y Email</p>
