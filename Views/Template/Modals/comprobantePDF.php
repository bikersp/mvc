...
<body>
	<table class="tbl-hader">
		<tbody>
			<tr>
				<td class="wd33">
					<img src="<?= media() ?>/store/img/logo.png" alt="Logo" width="150">
				</td>
				...
				<td class="text-right wd33">
					...
					<p>No. Factura <strong><?= $orden['idpedido'] ?></strong><br>
	...
	<div class="text-center">
		<p>Si tienes preguntas sobre tu pedido, <br> pongase en contacto con nombre, teléfono e Email</p>
