              ...
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control valid" id="txtNombre" name="txtNombre" autofocus type="text" placeholder="Nombre de la Categoria" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Descripción <span class="required">*</span></label>
                    <textarea class="form-control valid" id="txtDescripcion" name="txtDescripcion" rows="2" placeholder="Descripcion de la Categoria" required></textarea>
                  </div>
                  <div class="form-group">
