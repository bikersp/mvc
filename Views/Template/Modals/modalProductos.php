              ...
              <div class="row">
                <div class="col-lg-6 col-xl-8">
                  <div class="form-group">
                    ...
                    <input class="form-control valid" id="txtNombre" name="txtNombre" type="text" placeholder="Nombre del Producto" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-lg-6 col-xl-4">
                  <div class="form-group">
                    ...
                    <input class="form-control valid" id="txtCodigo" name="txtCodigo" type="text" placeholder="Código de barra" required>
                    <br>
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label class="listCategoria">Categoría <span class="required">*</span></label>
