      ...
      <div class="tile">
        ...
        <?php
            ...
            if (isset($trs->payments->refunds)) {
              $reembolso = true;
              $importaBruto = $trs->payments->refunds[0]->seller_payable_breakdown->gross_amount->value;
        ...
        <section id="sPedido" class="invoice">
          <div class="row mb-4">
            <div class="col-6">
              <h2 class="page-header"><img src="<?= media();?>/img/icon/paypal.jpg"></h2>
            </div>
            <?php
              if(!$reembolso){
          ...
          <div class="row invoice-info">
            <div class="col-4">
              <address>
                <strong>Transacción: <?= $idTransaccion; ?></strong><br><br>
            ...
            <div class="col-4">
              <address>
                ...
                <strong>Teléfono: <?= $telCliente;?></strong><br>
                <strong>Dirección: <?= $direccion1;?></strong><br>
                <?= $direccion2.', '.$direccion3.' '.$codPostal; ?> <br>
                <?= $codCiudad; ?>
              </address>
            </div>
            <div class="col-4"><b>Enviado a:</b><br><br>
          ...
          <div class="row">
            ...
            <table class="table table-sm">
              ...
              ?>
                <tr>
                  <td><?= $fechaReembolso.' Reembolso '.$nombreCliente; ?></td>
                  <td class="text-right">- <?= $importaBruto.' '.$moneda; ?></td>
            ...
            <?php } ?>
              ...
              <table class="table table-sm">
                ...
                <tbody>
                  <tr>
                    <td width="250"><b>Total de la Compra</b></td>
                    <th><?= $totalCompra.' '.$moneda;?></th>
                  </tr>
                  <tr>
                    <td><b>Comisión de Paypal</b></td>
                    <td>- <?=$comision.' '.$moneda;?></td>
                  </tr>
                  <tr>
                    <td><b>Importe Neto</b></td>
